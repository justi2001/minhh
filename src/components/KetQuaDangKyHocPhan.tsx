...
const KetQuaDangKyHocPhan: React.FC = () => {
  ...
  const hocPhanData: HocPhan[] = [
    {
      stt: 1,
      maHocPhan: 'CNTT1128(125)_02',
      tenHocPhan: 'Cơ sở lập trình',
      soTinChi: 3,
      ngayDangKy: '14/07/2025 13:18:00'
    },
    {
      stt: 2,
      maHocPhan: 'DTKT1154(125)_08',
      tenHocPhan: 'Kinh tế đầu tư',
      soTinChi: 3,
      ngayDangKy: '10/07/2025 10:10:00'
    },
    {
      stt: 3,
      maHocPhan: 'GDTC1105(125)1_01',
      tenHocPhan: 'Bóng chuyền 3',
      soTinChi: 2,
      ngayDangKy: '27/08/2025 10:27:46'
    },
    {
      stt: 4,
      maHocPhan: 'LLNL1106(125)_11',
    ...
    {
      stt: 5,
      maHocPhan: 'PTKT1128(125)_07',
      tenHocPhan: 'Kinh tế phát triển',
      soTinChi: 3,
      ngayDangKy: '14/07/2025 13:21:00'
    },
    {
      stt: 6,
      maHocPhan: 'PTKT1128(125)_07_TL_02',
      tenHocPhan: 'Kinh tế phát triển',
      soTinChi: 3,
      ngayDangKy: '14/07/2025 13:21:00'
    },
    {
      stt: 7,
      maHocPhan: 'TKKD1102(125)_01',
      tenHocPhan: 'Lý thuyết thống kê 2',
      soTinChi: 3,
      ngayDangKy: '10/07/2025 10:10:00'
    },
    {
      stt: 8,
      maHocPhan: 'TMKQ1123(125)_09',
      tenHocPhan: 'Kinh tế quốc tế',
      soTinChi: 3,
      ngayDangKy: '10/07/2025 10:10:00'
    }
  ];
    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-semibold text-blue-600">Kết quả đăng ký học phần</h1>
        </div>
            ...
            <table className="min-w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {hocPhanData.map((hocPhan, index) => (
                  <tr key={hocPhan.stt} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
...
export default KetQuaDangKyHocPhan;
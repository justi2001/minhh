...
const ChiTietHoaDon: React.FC = () => {
  ...
  const hoaDonData: HoaDon[] = []; // Empty array as shown in the image
    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-semibold text-blue-600">Chi tiết hóa đơn</h1>
        </div>
                ...
                {hoaDonData.length === 0 ? (
                  ...
                  hoaDonData.map((hoaDon, index) => (
                    <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {hoaDon.hinhThucNopTien}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {hoaDon.thanhTien.toLocaleString('vi-VN')} VNĐ
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {hoaDon.chiTiet}
                      </td>
